...
pub const USED_PROOF_SEED: &[u8] = b"used_proof"; // UsedProof PDA 的固定前缀，防止同一 Quest 内重复使用外部证明。
...
pub const MAX_VERIFICATION_TTL_SECONDS: i64 = 3_600; // Auto-Review v1 verifier 结果最长有效期：1 小时。
